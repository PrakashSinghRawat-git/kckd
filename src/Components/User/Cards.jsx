...
const Card = ({ icon, heading, subHeading, categoryData, category }) => {
  ...
  return (
    <Link href={`/sub-category/${heading}?category=${category}`} className="flex hover:scale-105 items-center p-2 bg-gray-200 rounded-lg shadow-xs">
      {icon}
      <div>
