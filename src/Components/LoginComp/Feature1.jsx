const Index = () => (
    <div className="overflow-y-hidden bg-[#F79630]">
        <div className="xl:mx-auto xl:container  xl:px-20 md:px-6 px-4 py-12">
            <div className="lg:flex items-center justify-center lg:space-x-12 2xl:space-x-6">
                <div className>
                    <p className="lg:text-5xl text-4xl text-white font-extrabold leading-9 ">
                        Tutor Overview
                    </p>
                    <p className="text-lg leading-7 font-semibold text-black mt-4 xl:w-7/12 w-full">
                        Whether article spirits new her covered hastily sitting
                        her. Money witty books nor son add
                    </p>
                    ...
                    <div className="mt-6 md:mt-10 grid sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2 gap-6 lg:mt-6 2xl:mt-12">
                        <div className="flex items-center">
                            ...
                            <div className="flex items-start flex-col ml-6 pt-8">
                                <h2 className="text-lg text-white font-semibold leading-4 ">
                                    Time Prompt
                                </h2>
                                <p className="lg:w-40 text-white 2xl:w-52 text-base leading-6 mt-2 ">
                        ...
                        <div className="flex items-center">
                            ...
                            <div className="flex items-start flex-col ml-6 pt-8">
                                <h2 className="text-lg text-white font-semibold leading-4 text-gray-800">
                                    User Friendly
                                </h2>
                                <p className="lg:w-40 text-white 2xl:w-52 text-base leading-6 mt-2 ">
                                    Whether article spirits new her covered.
                        ...
                        <div className="flex items-center">
                            ...
                            <div className="flex items-start flex-col ml-6 pt-8">
                                ...
                                <p className="lg:w-40 2xl:w-52 text-base leading-6 mt-2 text-white">
                                    Whether article spirits new her covered.
                                </p>
                            </div>
                        </div>
                ...
                <div className="hidden lg:block lg:w-3/5 xl:w-3/5 w-full lg:mt-0 mt-6">
                    <img
                        ...
                        className="w-[75%] ] obejct-fit object-center object-fill h-full"
                    />
                </div>
            </div>
        </div>
